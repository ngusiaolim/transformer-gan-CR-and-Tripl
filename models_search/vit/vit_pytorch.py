...
from models_search.vit.pos_embed import get_2d_sincos_pos_embed
...
class ViT(nn.Module):
    def __init__(self, *, image_size, patch_size, num_classes=1000, dim, depth, heads, mlp_dim, pool='cls', channels=3,
